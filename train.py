...
#
# for item in data:
#     if item['SentencePolarity'] == '1':
#         positive_data_file.write(item['Sentence']+'\n')
#     elif item['SentencePolarity'] == '-1':
#         negative_data_file.write(item['Sentence'] + '\n')
#     else:
#         pass
#
...
tf.flags.DEFINE_string("positive_data_file", "./data/JK_POS.txt", "Data source for the positive data.")
